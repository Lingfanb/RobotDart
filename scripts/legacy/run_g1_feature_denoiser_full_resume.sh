#!/bin/bash
# Resume full rollout denoiser training from checkpoint_80000.pt after crash.
cd ~/Gitcode/DART
...
/home/lingfanb/miniforge3/envs/DART/bin/python -m mld.train_g1_mld \
    ...
    --train_args.resume_checkpoint ./mld_denoiser/g1_feature_mld_full/checkpoint_80000.pt \
    --num_primitive 4 \
