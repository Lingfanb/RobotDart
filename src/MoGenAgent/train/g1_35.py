...
class G1FM35Args:
    ...
    track: int = 1
    wandb_project_name: str = "g1_fm_35"
...
class G1FM35Trainer:
    ...
    def __init__(self, args: G1FM35Args):
        ...
        if args.data_source == 'va_npz':
            ...
            val_dataset = G1PrimitiveDataset35VA(
