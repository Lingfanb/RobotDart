...
Usage:
    cd ~/Gitcode/DART
    python -m VADFlowMoGen.train.legacy.g1_69 \\
        --exp_name g1_fm_69_v1 \\
...
class G1FM35Args:
    ...
    track: int = 1
    wandb_project_name: str = "g1_fm_69"
...
class G1FM35Trainer:
    ...
    def __init__(self, args: G1FM35Args):
        ...
        if args.data_source == 'va_npz':
            ...
            val_dataset = G1PrimitiveDataset69VA(
