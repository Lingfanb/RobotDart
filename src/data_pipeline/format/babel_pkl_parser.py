...
Reads the DART project's existing `data/processed/seq_data_g1/` (GMR-retargeted PKL)
...
class AmassBabelParser(DatasetParser):
    ...
    def __init__(self,
                 seq_data_dir: str = "data/processed/seq_data_g1",
                 babel_dir: str = "data/raw/amass/babel-teach"):
