...
from _legacy.mld.render.renderer import get_renderer
from _legacy.mld.render.rendermotion import render_video
...
def viz_dataset(dataset, params, folder):
    ...
    from _legacy.mld.models.rotation2xyz import Rotation2xyz
