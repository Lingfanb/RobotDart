...
## 1. Abstract (master, locked 2026-05-03)
...
- "First on humanoid" must survive lit search (sprint Day 5)
...
> - [../../plan/long_term.md](../../plan/long_term.md) — 长期 vision (含 13-week NMI roadmap, 2026-05-01 起承接旧 milestones)
> - [../../plan/short_term.md](../../plan/short_term.md) — 本周 focus + module 状态
> - [../architecture/module_build_list.md](../architecture/module_build_list.md) — per-M task details
> - 旧 milestones / module_status 已 archive 到 `../legacy/plan_*.md`
...
- [ ] Literature notes in `notes/paper/related_work_nmi.md`
