% =============================================================================
%  Universal Control Variables (UCV) — Report Section
...
UCV represents the affective style of any motion primitive as a continuous
...
\begin{description}
  ...
  \item[\textbf{Dominance} ($D$)] -- the ``active--passive'' engagement with
    ...
    In UCV we deliberately depart from the traditional \emph{static
