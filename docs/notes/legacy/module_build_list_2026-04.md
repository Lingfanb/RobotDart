...
**Purpose**: Per-module actionable build task list. Based on [architecture_agent.md](architecture_agent.md) (9-module design) and [../paper/nmi_inventory.md](../paper/nmi_inventory.md) (gap analysis).
