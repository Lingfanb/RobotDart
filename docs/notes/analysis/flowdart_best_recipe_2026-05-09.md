...
## FlowDART Production Recipe (Tier 1.2 Motion Gen)
...
Fix at [render_g1_rollout_fm_35.py:348-355](../../../src/mld/render_g1_rollout_fm_35.py#L348-L355):
```python
...
- Render bug fix commit: see [render_g1_rollout_fm_35.py:348-355](../../../src/mld/render_g1_rollout_fm_35.py#L348-L355)
